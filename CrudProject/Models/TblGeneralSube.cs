...
{
    public partial class TblGeneralSube
    {
        public TblGeneralSube()
        {
        ...
        public string? SabitFoto { get; set; }
        public string? MersisNo { get; set; }
        public string? TicariSicilNo { get; set; }

        public virtual TblGeneralFirma Firma { get; set; } = null!;
        public virtual TblGeneralIl? Il { get; set; }
        public virtual TblGeneralIlce? Ilce { get; set; }
        public virtual TblGeneralKoy? MahKoy { get; set; }
        public virtual TblGeneralUlke? Ulke { get; set; }
